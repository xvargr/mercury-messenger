...
function ChatInputBox(props) {
  ...
  return (
    <form className="flex justify-center" onSubmit={returnMessageData}>
      <div className="w-full ml-2 h-[14%] max-h-32 backdrop-blur-sm bottom-0 -left-2 absolute blurMask45"></div>
      <div className="w-full ml-2 h-[14%] max-h-32 bg-gray-600 bottom-0 -left-2 absolute blurMask70"></div>
